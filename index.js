...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5598987583208 :+55 98 987583208\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5598987583208@s.whatsapp.net"] // replace this with your number
			const nomorOwner = ["5598987583208@s.whatsapp.net"]
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5598987583208@s.whatsapp.net'
                        /******ApiKey Input******/
  ...
  client.updatePresence(from, Presence.composing) 
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
			...
			case 'quotes':
              ...
              case 'owner':
                case 'creator':
                  client.sendMessage(from, {displayname: "MEU DONO^^", vcard: vcard}, MessageType.contact, { quoted: mek})
